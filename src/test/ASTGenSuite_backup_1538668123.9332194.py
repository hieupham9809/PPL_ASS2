...
"""
        expect = str(Program([FuncDecl(Id(foo),[],VoidType(),[],[AssignStmt(Id(g),BooleanLiteral(False)),AssignStmt(Id(f),Id(g)),AssignStmt(Id(e),Id(f)),AssignStmt(Id(d),Id(e)),AssignStmt(Id(c),Id(d)),AssignStmt(Id(b),Id(c)),AssignStmt(Id(a),Id(b)),AssignStmt(Id(g),BinaryOp(orelse,BinaryOp(andthen,BinaryOp(>,BinaryOp(-,BinaryOp(+,BinaryOp(+,UnaryOp(-,FloatLiteral(1.2)),BinaryOp(mod,BinaryOp(*,BinaryOp(*,FloatLiteral(4.6),IntLiteral(6)),IntLiteral(8)),IntLiteral(7))),Id(m)),BinaryOp(*,Id(f),Id(k))),BinaryOp(or,BinaryOp(-,BinaryOp(-,BinaryOp(+,IntLiteral(4),BinaryOp(*,IntLiteral(2),IntLiteral(5))),BinaryOp(div,IntLiteral(6),Id(abc))),UnaryOp(-,IntLiteral(4))),IntLiteral(3))),Id(nhyil)),BooleanLiteral(True)))])]))
