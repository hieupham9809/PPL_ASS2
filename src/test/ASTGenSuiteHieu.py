...
class ASTGenSuite(unittest.TestCase):
    ...
    def test_array_DECLARE_with_ARRAY_signed(self):
        input = r"""var d:array [-1 .. 5] of integer; a,b,c: integer; e,f: real;"""
        expect = str(Program([VarDecl(Id(r'd'),ArrayType(-1,5,IntType())),VarDecl(Id(r'a'),IntType()),VarDecl(Id(r'b'),IntType()),VarDecl(Id(r'c'),IntType()),VarDecl(Id(r'e'),FloatType()),VarDecl(Id(r'f'),FloatType())]))
    ...
    def test_array_DECLARE_with_ESCAPEs(self):
        ...
        begin
        "2"[4]:=d; end"""
        expect = str(Program([FuncDecl(Id(r'foo'),[VarDecl(Id(r'a'),IntType()),VarDecl(Id(r'b'),IntType()),VarDecl(Id(r'c'),FloatType())],[],[Assign(ArrayCell(StringLiteral(r'2'),IntLiteral(4)),Id(r'd'))],VoidType())]))
    ...
    def test_assign_more_compound(self):
        ...
        """
        expect = str(Program([FuncDecl(Id(foo),[],VoidType(),[],[With([VarDecl(Id(i),IntType)],[CallStmt(Id(ok),[])])])]))
...
"""
        expect = str(Program([FuncDecl(Id(foo),[],VoidType(),[],[With([VarDecl(Id(i),IntType),VarDecl(Id(j),IntType),VarDecl(Id(k),IntType)],[])])]))
...
"""
        expect = str(Program([FuncDecl(Id(r'foo'),[],[],[Assign(Id(r'g'),BooleanLiteral(False)),Assign(Id(r'f'),Id(r'g')),Assign(Id(r'e'),Id(r'f')),Assign(Id(r'd'),Id(r'e')),Assign(Id(r'c'),Id(r'd')),Assign(Id(r'b'),Id(r'c')),Assign(Id(r'a'),Id(r'b'))],VoidType())]))
...
"""
        expect = str(Program([FuncDecl(Id(r'foo'),[],[],[Assign(Id(r'a'),StringLiteral(r''))],VoidType())]))
...
End
        """
        expect = str(Program([VarDecl(Id(r'n1'),StringType()),VarDecl(Id(r'n2'),StringType()),FuncDecl(Id(r'main'),[],[],[CallStmt(Id(r'Writeln'),[StringLiteral(r'Enter two numbers: (\"\"0\"\" & \"\"0\"\" to exit)')]),While(UnaryOp(r'not',BinaryOp(r'AND',BinaryOp(r'=',Id(r'n1'),StringLiteral(r'0')),BinaryOp(r'=',Id(r'n2'),StringLiteral(r'0')))),[CallStmt(Id(r'Write'),[StringLiteral(r'No.1: ')]),CallStmt(Id(r'Readln'),[Id(r'n1')]),CallStmt(Id(r'Write'),[StringLiteral(r'No.2: ')]),CallStmt(Id(r'Readln'),[Id(r'n2')]),If(BinaryOp(r'AND',BinaryOp(r'=',Id(r'n1'),StringLiteral(r'0')),BinaryOp(r'=',Id(r'n2'),StringLiteral(r'0'))),[CallStmt(Id(r'Halt'),[IntLiteral(0)])],[])])],VoidType())]))
        self.assertTrue(TestAST.test(input,expect,386))
    
    def test_complex_with_comment(self):
        input = """
var
...
begin
   ...
   writeln("value of a is : ", a);
        ...
        """
        expect = str(Program([VarDecl(Id(r'a'),IntType()),FuncDecl(Id(r'main'),[],[],[Assign(Id(r'a'),IntLiteral(10)),If(BinaryOp(r'<',Id(r'a'),IntLiteral(20)),[CallStmt(Id(r'writeln'),[StringLiteral(r'a is less than 20 ')])],[]),CallStmt(Id(r'writeln'),[StringLiteral(r'value of a is : '),Id(r'a')])],VoidType())]))
        self.assertTrue(TestAST.test(input,expect,387))
    def test_statement_while_and_assign(self):
        ...
        input = """function foo(c: real; d: integer): integer;
                   BEGIN
                    ...
                    return c; end
                   END"""
        expect = str(Program([FuncDecl(Id(r'foo'),[VarDecl(Id(r'c'),FloatType()),VarDecl(Id(r'd'),IntType())],[],[While(BooleanLiteral(True),[Assign(Id(r'd'),BinaryOp(r'+',ArrayCell(Id(r'c'),Id(r'a')),Id(r'b'))),Continue(),Return(Id(r'c'))])],IntType())]))
        

        self.assertTrue(TestAST.test(input,expect,388))
    def test_while_and_compound(self):
        input = """
var
   a: integer;
...
begin
   ...
   begin
    ...
    def test_statement_PROCEDURE_missing_SEMI(self):
        ...
        expect = str(Program([FuncDecl(Id(r'foo'),[VarDecl(Id(r'a'),IntType()),VarDecl(Id(r'b'),IntType()),VarDecl(Id(r'c'),FloatType())],[VarDecl(Id(r'x'),FloatType()),VarDecl(Id(r'y'),FloatType()),VarDecl(Id(r'z'),ArrayType(2,3,IntType()))],[If(BinaryOp(r'>',IntLiteral(5),IntLiteral(6)),[Assign(Id(r'x'),Id(r'y'))],[If(BooleanLiteral(True),[Assign(Id(r'y'),Id(r'x'))],[])])],VoidType())]))
    ...
    def test_statement_FUNCCALL_as_index_expr(self): 
        input = r"""procedure foo(a,b:integer; c:real);
        var x,y: real;
            z: array[2 .. 3] of integer;
        begin 
    ...
    def test_statement_CALL_with_more_param(self):
        input = r"""function foo(c: real): integer;
                   BEGIN
                    foo(3,a+1,x and then y, c,a[1],foo(1,2)[m+1]);
                    return foo2() + foo() + 1;
    ...
    def test_statement_FUNCTION_return(self):
        input = r"""
        var x, y: real;
    ...
    def test_statement_nested_more_WITH(self):
        input = r"""function nested_WITH(d: real): sTRIng;
                   BEGIN
                    with c , d : integer ; c : array [1 .. 2] of real ; do
                    with a , b : integer ;
    ...
    def test_manydecls_underline_name(self):
        input = r"""
            ...
            vAr __ : STRING;
            """
        expect = str(Program([VarDecl(Id(r'myVar'),IntType()),VarDecl(Id(r'foo'),FloatType()),VarDecl(Id(r'bar'),FloatType()),FuncDecl(Id(r'a'),[VarDecl(Id(r'b'),ArrayType(-1,1,BoolType()))],[],[CallStmt(Id(r'doSomething'),[])],BoolType()),VarDecl(Id(r'__'),StringType())]))
        self.assertTrue(TestAST.test(input,expect,396))
    def test_manydecls_underline_and_normal_name(self):
        input = r"""
            VaR myVar : INTEGER ; foo   ,   bar: real;
            function a(b:array [-1 .. 1] of BOOLEAN):boolean;
            begin
            ...
            vAr __more : STRING;
            """
        expect = str(Program([VarDecl(Id(r'myVar'),IntType()),VarDecl(Id(r'foo'),FloatType()),VarDecl(Id(r'bar'),FloatType()),FuncDecl(Id(r'a'),[VarDecl(Id(r'b'),ArrayType(-1,1,BoolType()))],[],[CallStmt(Id(r'doSomething'),[])],BoolType()),VarDecl(Id(r'__more'),StringType())]))
        self.assertTrue(TestAST.test(input,expect,397))
    def test_statement_ASSIGN_index_express_of_FUNCCALL(self):
        input = r"""FUNCTION ASSIGN_with_index_express_of_FUNCCALL(c: integer): integer ;
                   var x,y: integer;
                   BEGIN
                    a[m+n] := a[m+1] := foo()[m*2] := a[2 div a] := (a>=m)
    ...
    def test_statement_more_ASSIGN_single(self):
        input = r"""proCeduRE foo(m, n: integer; c: real) ;
                  var x,y,z: real ;
                  BEGIN
                    m := 12;
                    ...
                    z := c[2];
                  END"""
        expect = str(Program([FuncDecl(Id(r'foo'),[VarDecl(Id(r'm'),IntType()),VarDecl(Id(r'n'),IntType()),VarDecl(Id(r'c'),FloatType())],[VarDecl(Id(r'x'),FloatType()),VarDecl(Id(r'y'),FloatType()),VarDecl(Id(r'z'),FloatType())],[Assign(Id(r'm'),IntLiteral(12)),Assign(Id(r'n'),ArrayCell(Id(r'c'),IntLiteral(2))),Assign(Id(r'z'),Id(r'n')),Assign(Id(r'm'),Id(r'z')),Assign(Id(r'z'),ArrayCell(Id(r'c'),IntLiteral(2)))],VoidType())]))
        self.assertTrue(TestAST.test(input,expect,399))
    def test_statement_withs_nested_COBOUND(self):
        ...
        input = r"""
                ...
                BEgin
	               ...
	               BEgin
		                 b := c ;
		                 if(e <> f) then begin test1(a,c) ; end{example}
	               EnD
                EnD
                """
        expect = str(Program([FuncDecl(Id(r'test1'),[],[],[If(BinaryOp(r'=',Id(r'a'),Id(r'b')),[Assign(Id(r'b'),Id(r'c')),If(BinaryOp(r'<>',Id(r'e'),Id(r'f')),[CallStmt(Id(r'test1'),[Id(r'a'),Id(r'c')])],[])],[])],VoidType())]))
    ...
    def test_statement_index_expression_with_IF(self):
        input = r"""
                ...
                End
                """
        expect = str(Program([FuncDecl(Id(r'replaceNumber'),[VarDecl(Id(r'A'),ArrayType(0,100,IntType())),VarDecl(Id(r'N'),IntType()),VarDecl(Id(r'x'),IntType()),VarDecl(Id(r'y'),IntType())],[VarDecl(Id(r'i'),IntType())],[For(Id(r'i'),IntLiteral(0),Id(r'N'),True,[If(BinaryOp(r'=',ArrayCell(Id(r'A'),Id(r'i')),Id(r'x')),[Assign(Id(r'y'),Id(r'z')),Assign(ArrayCell(Id(r'A'),Id(r'i')),Id(r'y'))],[])]),Return(None)],VoidType())]))
        self.assertTrue(TestAST.test(input,expect,401))
    def test_statement_assign_more(self):
        input = r"""
                procedure a();
        begin
            a:=2.3;
